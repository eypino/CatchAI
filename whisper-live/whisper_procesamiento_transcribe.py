...
chunk_duration = 4 # segundos por chunk a procesar
channels = 1 # mono
...
try:
    ...
    glosario = set(pd.read_csv(r"C:\Users\Midorisha\Desktop\proyecto\whisper-live\diccionario_lsch_glosas_corregido.csv")["Palabra"].str.upper().str.strip().tolist())
